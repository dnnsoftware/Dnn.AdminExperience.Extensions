...
namespace Dnn.PersonaBar.Library.PersonaBar.Model
{
    ...
    public class MenuItem : IHydratable
    {
        ...
        public string DisplayName
        {
            get
            {
                var resourcesPath = System.IO.Path.Combine(Constants.PersonaBarRelativePath, "Modules", Identifier, "App_LocalResources", ModuleName + ".resx");
                ...
                if (string.IsNullOrEmpty(displayName))
                {
                    ...
                    displayName = Localization.GetSafeJSString(ResourceKey, resourcesPath);
                }
