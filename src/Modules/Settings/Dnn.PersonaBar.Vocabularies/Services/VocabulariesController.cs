...
{
    [ServiceScope(Identifier = "Vocabularies")]
    public class VocabulariesController : PersonaBarApiController
    {
        ...
        private static string localResourcesFile = Path.Combine("~/admin/Dnn.PersonaBar/Modules/Vocabularies/App_LocalResources/Vocabularies.resx");
